apt update
apt upgrade -y
apt install git curl sudo apt-transport-https software-properties-common ca-certificates python3-distutils pkg-config libsystemd-dev -y
...
apt install xpra-filesystem xpra-common xpra-client xpra-client-gtk3 xpra-server xpra-x11 xpra-audio xpra-codecs xpra-codecs-extras xpra-codecs-nvidia -y
