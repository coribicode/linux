...
PACKAGES_DEPENDECES="libva-drm2 libva-x11-2 libva-drm2 libva-x11-2 libjs-jquery libjs-jquery-ui libx264-dev libvpx-dev libwebp-dev libgtk-3-dev libsystemd-dev libvpx9 libwebp9 libx11-dev libxtst-dev libxcomposite-dev libxdamage-dev libxres-dev libxkbfile-dev liblz4-dev libpam0g-dev libturbojpeg0-dev"
INSTALLING
