...
apt install libwine fonts-wine libvkd3d1 libz-mingw-w64 libwine wine-binfmt binfmt-support wine64-preloader wine64-tools
...
sudo -u $USER winetricks dxvk d3dx9 directx9 corefonts xinput windowscodecs msxml3 msxml6 mfc140 directplay dsound
