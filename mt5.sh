...
apt install -y --install-recommends libc6-i386 zlib1g libx11-6 libxft2 libcairo2 libvulkan1 vulkan-tools libpcl1 libvulkan1:i386 libmpg123-dev libwine fonts-wine libvkd3d1 libz-mingw-w64 libwine wine-binfmt binfmt-support wine64-preloader wine64-tools
