...
apt install -y --install-recommends gcc-multilib g++-multilib libc6-i386 zlib1g libx11-6 libxft2 libcairo2 libvulkan1 vulkan-tools libvulkan1:i386 libwine fonts-wine libvkd3d1 libz-mingw-w64 libwine wine-binfmt binfmt-support wine64-preloader wine64-tools
