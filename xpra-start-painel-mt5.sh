...
PACKAGES="python3 python3-pyqt5 python3-tk python3-psutil python3-pyqt5.qtsvg python3-netifaces cgroup-tools x11-xserver-utils procps psmisc cabextract zenity xdg-utils wmctrl p7zip-full zram-tools unzip"
echo
